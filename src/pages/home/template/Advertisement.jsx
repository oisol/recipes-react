...
const style = {
    ...
    mainDiv: `flex justify-around w-full px-9 mt-8`,
    adCard: `bg-white w-1/5 h-32 rounded-xl p-2 flex flex-col items-center cursor-pointer shadow-3xl`,
    adCardAlt: `bg-orange-400 w-1/5 h-32 rounded-xl p-2 flex flex-col items-center cursor-pointer shadow-3xl animate-pulse`,
